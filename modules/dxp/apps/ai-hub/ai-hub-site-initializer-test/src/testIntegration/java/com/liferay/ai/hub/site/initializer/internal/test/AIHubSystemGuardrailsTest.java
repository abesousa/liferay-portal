...
public class AIHubSystemGuardrailsTest {
	...
	public void testGetSystemObjectEntries() throws Exception {
		for (String externalReferenceCode :
			...
			Assert.assertEquals(
				objectEntry.toString(), "output", values.get("guardrailType"));
		}
	}
	...
	public void testUpdateSystemObjectEntryWithoutPermissions()
		...
		String originalDescription = (String)originalValues.get("description");
		...
		ObjectEntry objectEntryAfter = _fetchSystemObjectEntry(
			"L_AI_HUB_SG_3_OUTPUT_FILTER");

		Map<String, Serializable> valuesAfter = objectEntryAfter.getValues();

		Assert.assertEquals(
			objectEntryAfter.toString(), originalDescription,
			valuesAfter.get("description"));
	}
