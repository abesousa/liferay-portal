...
public interface DDMFieldAttributePersistence
	 ...
	 */
	public java.util.List<DDMFieldAttribute> findByFieldId(
	 ...
	 */
	public default java.util.List<DDMFieldAttribute> findByFieldId(
		long fieldId) {

		return findByFieldId(
			fieldId, com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS,
	...
	public default java.util.List<DDMFieldAttribute> findByFieldId(
		...
		return findByFieldId(fieldId, start, end, null, true);
	}
	...
	public default java.util.List<DDMFieldAttribute> findByFieldId(
		...
		return findByFieldId(fieldId, start, end, orderByComparator, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:1899536392